...
```text
inputตัวเลข4ค่า คือ ช่วงของจำนวน และ ตัวหาร และ ตัวเศษ นำมาคำนวนหา จำนวนที่หารตัวหารแล้วเหลือตัวเศษตัวนั้น
```
...
```text
Step 1:รับค่าinput4ค่า
Step 2:สร้างลูปโดยเริ่มที่Aจบที่B
Step 3:ในลูปสร้างเงื่อนไขถ้าหารdเหลือเศษrเพิ่มxไปฝ1
```
...
```text
เหมือนกันเพราะไม่ได้ติดปัญหาอะไร
```
...
```text
ทดสอบถ้าไม่มีอะไรตรงเงื่อนไขเลย
```
