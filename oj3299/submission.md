...
```text
รับ Input เป็นความหนาของแถวและจำนวนช่องที่ปลูก Output คือหมายเลขแถวของช่องสุดท้ายนั้น เงื่อนไขสำคัญคือการปลูกจะเรียงตามแนวทะแยง โดยในแต่ละแถวจะปลูกแนวตั้งให้ครบช่องก่อนแล้วค่อยไล่คอลัมน์ถัดไป ซึ่งความยาวแถวจะเพิ่มขึ้นเรื่อยๆเมื่อสะสมช่องปลูกจนครบช่องก็นำลำดับแถวรวมมาหารด้วย แล้วปัดเศษขึ้นเพื่อหาคำตอบ
```
...
```text
Step 1:import mathเข้ามาในโค้ด
Step 2:รับค้่าinputเป็นควา่มหนาและจำนวนช่องที่จะปลูก
Step 3:สร้างตัวแปรกำหนดค่าเป็น0เพื่อใช้ในการนับ
Step 4:วนลูปโดยใช้while loopคำนวณสะสมดอกไม้
Step 5:เมื่อได้จำนวนแถวทั้งหมดแล้ว โปรแกรมจะนำค่า row ไปหารด้วย a แล้วแสดงผล
```
...
```text
เหมือนวิธีแรกทุกอย่าง เพราะสามารถใช้งานได้
```
