...
```text
inputเป็นระยะการกระโดดและระยะทาง outputเป็นจำนวนครั้งการกระโดดโดยถ้ากระโดดไม่ถ฿งให้พิมพ์ "-1"
```
...
```text
Step 1:รับค่าinputเข้ามา
Step 2:สร้างลูปในการคำนวนการคำนวนกระโดดโดยใช้while loopตั้งเงื่อนไขให้ทำเมื่อระยะทางที่กระโดดได้น้อยกว่าระยะทางการกระโดษที่ต้องการเมื่อระยะทางมากกว่าให้ออกจากลูปหริอถ้าระยะการกระโดดน้อยกว่าหรือเท่ากับ0ก็ออกจากลูปเช่นกัน
Step 3:ตั้งเงื่อนไขถ้าระยะทางการกระโดดน้อยกว่าระยะทางที่ต้องการให้แสดงผลเป้น-1ถ้ามากกว่าแสดงเป็นจำนวนครั้งการกระโดด
```
...
```text
เหมือนแผนแรกทุกอย่างเพราะมันสามารถใช้งานได้
```
...
```text
ทดสอบเงื่อนไขที่แรงกระโดดหมดลงก่อนถึงระยะเป้าหมาย
```
...
```text
ทดสอบกรณีที่ระยะการกระโดดครั้งแรก
```
