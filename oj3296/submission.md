...
```text
Input คือค่าความเข้มสีของแม่สีแสง 3 ช่อง(แดง,เขียว,น้ำเงิน)ของแต่ละสี ซึ่งรับเข้ามาทั้งหมด 2 บรรทัด บรรทัดละ 3 จำนวนOutput คือค่าสีใหม่ที่เกิดจากการผสมสี โดยแสดงผลเป็นค่าแม่สี R, G, B จำนวนเต็ม 3 ค่าในบรรทัดเดียว คั่นด้วยช่องว่างเงื่อนไขสำคัญ คือการคำนวณสีใหม่ทำได้โดยการหา ค่าเฉลี่ยของความเข้มสีในแต่ละช่องแล้วปัดเศษลงให้อยู่ในรูปจำนวนเต็ม
```
...
```text
Step 1:รับค่าinputเป็น จน.เต็ม3ค่า2บรรทัด
Step 2:คำนวณค่าเฉลี่ยของแต่ละสี โดยเอาแต่ละค่ามารวมกันหาร2
Step 3:แสดงผล
```
...
```text
เหมือนวิธีแรกทุกอย่างเพราะวสามารถใช้งานได้
```
...
```text
ทดสอบการปัดเศษลงเมื่อผลรวมเป็นเลขคี่
```
...
```text
ทดสอบกรณีค่าขอบเขตขั้นต่ำและความมืดสุด
```
...
```text
ทำทุกอย่างทั้งคิดวิธีและเขียนโค้ด
```
