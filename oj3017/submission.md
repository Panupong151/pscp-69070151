...
```text
inputเป็นราคาอาหารและเครื่องดื่ม outputเป็นค่าใช่จ่ายทั้งหมด ข้อจำกัดคือค่าบริการขั้นต่ำคือ50สูงสุด1000บาท
```
...
```text
Step 1:สร้างตัวแปรรับค่าราคาอาหารและเครื่องดื่ม
Step 2:คำนวณหาค่าบริการโดยเอาราคาในตอนแรกคูณกับ0.1หาค่าบริการแล้ว
Step 3:นำกลับไปบวกกับราคา
Step 4:เอาผลลัพธ์ที่ได้คุณ0.7
Step 5:นำกลับไปบวกกับราคา
Step 6:แสดงผล
```
...
```text
สร้างตัวแปรเก็บราคาแล้วนำมาคูณหาค่าบริการและvatแล้วนำไปบวกกับราคาแทบจะเหมือนวิธ๊แรกทุกประการ
```
...
```text
ช่วยใบ้ว่าฉันผิดตรงไหน
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดในตอนแรกทั้งหมดแต่ฉันเขียนคำสั่งผิดเล็กน้อย
```
