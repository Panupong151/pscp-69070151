...
```text
inputเป็นตัวอักษรหรือจำนวนเต็มแล้วตามด้วยตัวอักษร
outputเป็นชื่อเต็ม ของไพ่
โดยไพ่ที่มีหมายเลข A คือเอซ J คือแจ็ค Q คือควีน และ K คือ คิง
...
```text
Step 1:สร้างdictionaryเก็บค่าไพ่รับค่าตัวอักษร
Step 2:นำเข้าเงื่อนไขแล้วตรวจโดยใช้dictionary
Step 3:แสดงผล
```
...
```text
เหมือนวิธีแรกทุกอย่างเพราะสามารถใช้งานได้
```
