...
```text
inputเป็นข้อความอะไรสักอย่างแล้วแสดงผลออกมาจำนวนสระว่า ตัวไหน มี กี่ตัว
```
...
Step 2:สร้างลิสสระเอาไว้เช็ค
Step 3:สร้างลูปเพื่อเช็คสระว่าตัวไหนมีกี่ตัว
```
...
```text
เหมือนกับวิธีแรกเพราะใช้แล้วมันผ่าน
```
