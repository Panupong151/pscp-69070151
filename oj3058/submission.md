...
```text
inputรับค่า3ค่า คือ อิฐก้อนใหญ่ ก้อนเล็ก และ ความยาวของสะพานที่ต้องการสร้าง โดยoutput ที่ออกมาต้องเป็น จำนนวนอิฐก้อนเล็กที่ใช้น้อยที่สุด
constraints คือ ใช้อิฐก้อนใหญ่ให้ได้มากที่สุดก่อนจะใช้อิฐก้อนเล็กเสมอถ้าก้อนใหญ่มีเกิน ก็ให้ใช้เท่าที่ใช้ได้ แล้วนำก้อนเล็กมาโปะ
```
...
```text
Step 1:รับค่าinput
คำนวนหาเป้าหมายโดยการเอาค่าgoalมาหาร5หาจำนวนอิฐก้อนใหญ่ที่ใช้ได้ แต่ไม่เกินเป้าหมาย
Step 2:เอาค่าที่ได้มาลบเป้าหมายหาอิฐก้อนเล็ก
Step 3:ตรวจสอบว่าเพียงพอหรือไม่ถ้าไม่ให้แสดง-1
```
...
```text
เหมือนแผนแรกไม่ได้พลิกแพลงอะไรมากเพราะโจทย์ค่อนข้างตรงไปตรงมา
```
...
```text
ทดสอบว่าโปรแกรมทำงานได้ปกติหรือไม่
```
...
```text
ทดสอบ ถึงจะมีอิฐก้อนใหญ่เยอะแต่ใช้จริงๆไม่ถึง
```
