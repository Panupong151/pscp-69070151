...
```text
รับค่าinput เป็น ต้นทาง และปลายทาง และน้ำหนักของพัสดุ นำค่าไปพิจารณาตามตารางและแสดงoutputออกมาเป็นราคาการนำส่ง แต่หากเส้นทางอยู่นอกเหนือตารางให้แสดงerror
```
...
```text
Step 1:รับค่า ต้นทาง รับค่า ปลายทาง รับค่า น้ำหนักของพัสดุ
Step 2:พิจารณาตามเส้นทางในตารางโดยใช้if elif และelseตั้งแต่เส้นทางที่1ถึงุ
Step 3:แสดงผลตามเงื่อนไข
```
...
```text
เหมือนแผนแรกทุกอย่างเพราะทำแล้วโค้ดสามารถใช้งานได้
```
...
```text
ตรวจสอบการคำนวณของเส้นทางที่ 3
```
...
```text
ตรวจสอบน้ำหนักที่0กก.สำหรับเส้นทางที่5
```
