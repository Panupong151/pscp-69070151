...
```text
inputเป็นค่าเริ่มต้น และจุดสิ้นสุดของการหาจำนวนเฉพาะนั้น outputเป้นจำนวนเฉพาะ ละ จำนวนสมาชิก
```
...
```text
Step 1:รับค่าinputเป็นเลข สองเลข ในบรรทัดเดียว
Step 2:เข้าลูปและตั้งเงื่อนไขในลูป ถ้าหารลงตัวให้ค่าเป็นFalse ถ้าหารไม่ลงตัวให้เป็นTrue และเพิ่มลงในลิส
Step 3:แสดงผล
```
...
```text
เหมือนวิธีแรกทุกอย่างเพราะมันสามารถใช้งานได้
```
...
```text
ทดสอบช่วงตัวเลขที่ไม่มีจำนวนเฉพาะอยู่เลย
```
...
```text
ทดสอบช่วงตัวเลขที่startและstopเท่ากัน
```
...
```text
ทดสอบช่วงตัวเลขที่เริ่มต้นจาก0
```
