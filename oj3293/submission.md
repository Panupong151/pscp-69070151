...
```text
inputเป็นข้อความ 5บรรทัด และแสดงoutputออกมาเป็นข้อความ5บรรทัดที่ล้อมด้วย*
```
...
```text
Step 1:สร้างlistมาเก้บข้อความ ใช้for loopรับค่าinputข้อความ
Step 2:สร้างmax_lenขึ้นมา เพื่อเก็บจำนวนตัวอักษรเพื่อใช้ในการล้อมด้วย*
Step 3:สร้างตัวแปรborderเพื่อไว้แสดงผลขอบบนและล่างของข้อความ
Step 4:ปริ้นborderและลูปแสดงผลข้อความและปริ้นborderตกท้าย
```
...
```text
ทดสอบกรณีมีบรรทัดที่เป็น ช่องว่าง
```
...
```text
ทดสอบกรณีบรรทัดมีความยาวเท่ากันทั้งหมด
```
...
```text
กรณีข้อความยาวมากปนกับข้อความสั้น 1 ตัวอักษร
```
