...
```text
inputเป็นเดือนและวันที่ ดูว่าวันนั้นเป็นฤดูอะไร outputที่ออกมาต้องเป็นฤดูกาล ข้อจำกัดคือฤดูจะเปลี่ยนในทุกๆวันที่21ในเดือนที่หาร3ลงตัว
```
...
```text
Step 1:รับค่าเดือนและวันเข้ามา
Step 2:ตั้งเงื่อไขว่าต้องมีวันที่มากกกว่า21ของ12หรือเป็นเดือน1,2และวันที่น้อยกว่า21ของเดือน3ถึงฤดูจะเป็นwinterและก็ทำแบบนี้ซ้ำๆกับอันอื่นด้วย
Step 3:แสดงผล
```
...
```text
เหมือนกับแผนแรกทุกอย่าง เพราะเมื่อลองเขียนดูแล้วโค้ดสามารถทำงานได้และผ่านทุกtestcase
```
