...
| Item | Answer |
|---|---|
| OJ problem number/title | 3031 |
| OJ submission ID, if submitted | 587492 |
| OJ status | Pass |
...
```text
แก้เอ้าพุดจากตอนแรกให้พิมพ์ลูปแต่ติดerrorเพราะไม่มีตัวแปรเก้บค่าคำตอบ
```
...
```text
ฉันควรค่อยคิดและเขียนทุกอย่างลงในกระดาษเพื่อหาจุดเชื่อโยงแล้วเขียนเป็นสูตรออกมา
```
