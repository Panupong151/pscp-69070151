...
```text
inputเป็นค่าตัวอักษร และทำให้outputที่ออกมาเป็นการกลับตัวอักษรจากหลังไปหน้า ข้อจำกัดคือต้องเป็นพิมพ์เล็ก
```
...
```text
Step 1:สร้างตัวแปรtextรับค่าstr
Step 2:แทนค่าตัวแปรtextด้วยตัวแปรtextก่อนหน้าที่ถูกย้อนกลับตัวอักษรแล้ว(text = text[::-1])
Step 3:แสดงค่าtextโดยให้เป็นพิมพ์เล็กด้วยคำสั่ง.lower()
```
...
```text
สร้างตัวแปรเก็บค่าtextทำให้มันย้อนกลับด้วยคำสั่่ง[::-1]และสแดงผลออกมาเป็นตัวพิมพ์เล็ก
```
