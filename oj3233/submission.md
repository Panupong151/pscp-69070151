...
```text
inputมีสองบรรทัดเป็นผลรางวัล และ สลากที่มีอยู่ outputจำนวนเงินรางวัลสูงสุดที่ได้รับ หากไม่ถูกรางวัลเลยให้แสดง 0 หากถูกหลายรางวัลพร้อมกัน ให้คิดเฉพาะรางวัลที่มีมูลค่า สูงที่สุด เพียงรางวัลเดียว
```
...
```text
Step 1:รับค่า ผลการออก และ สลากที่มีอยู่
Step 2:เช็กตัวอักษรและเลข ตรวจสอบรางวัลแต่ละประเภทแล้วเก็บเข้า ลิสต์
Step 3:ใช้ฟังก์ชัน max ค้นหามูลค่ารางวัลที่สูงที่สุดในลิสต์ แล้วแสดงผล
```
...
```text
เหมือนแผนแรกทุกอย่างเพราะสามารถใช้งานได้
```
