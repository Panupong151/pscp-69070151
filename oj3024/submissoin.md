...
```text
รับค่าinputเป็นคะแนนรวมและคะแนนสูงสุด outputออกมาเป็นข้อความว่ามีsupriseหรือไม่ เงื่อนไขสำคัญคือค่าmaxและminต้องห่างกันเกิน2ถึงจะsuprise
```
...
Step 2:คำนวนโดยเพิ่มตัวแปรมาใช้checkด้วยสูตรMax_score*3 -2
Step 3:ถ้าsum_scoreน้อยกว่าcheckเกิน2ให้เป็นsuprise
step 4:แสดงผล
```
...
```text
รับค่าตัวแปรคะแนนรวมและคะแนนสูงสุด เอามาหาความเป้นไปได้ของค่าminสูตร sum_score - Max_score*2 แล้วเอาmaxไปลบminถ้ามากกว่า2ให้เป็นsuprise
```
