...
```text
inputเป็นค่า จำนวนร้าน จำนวนช่วงเวลาที่ต้องการตรวจสอบ เวลาปิดเวลาเปิด ช่วงเวลาที่ต้องการตรวจสอบ outputคือจำนวนร้านที่เปิดในช่วงเวลานั้นๆ
```
...
```text
Step 1:รับค่าnum,check
Step 2:สร้างกระดานนับร้านเปิดเตรียมไว้
Step 3:บันทึกช่วงเวลาเปิด-ปิดของแต่ละร้าน
Step 4:รับช่วงเวลาที่ต้องการตรวจสอบในบรรทัดสุดท้ายวนลูปหยิบค่าจำนวนร้านที่เปิด
Step 5:แสดงผล
```
...
```text
เหมือนแผนแรกืุกอย่างเนื่อจากใช้เวลาคิดให้ตรงกับเงื่อไขในแผนแรกค่อนข้างนานทำให้แผนแรกที่ใช้มีความสมบูณร์แบบและใช้งานได้
```
...
```text
ทดสอบเงื่อนไขขอบเขตการเปิดปิดร้าน
```
...
```text
ทดสอบการเปิดพร้อมกันหลายร้าน และช่วงเวลาที่ไม่มีร้านเปิด
```
...
```text
ทดสอบเวลาขอบเขตของวันและเวลาที่ทุกร้านปิดทั้งหมด
```
