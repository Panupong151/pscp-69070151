...
```text
inputค่าอุณหภูมิและหน่วยของอุณหภูมินั้นและหน่วยที่ต้องการจะเปลี่ยน outputออกมาเป็นค่าอุณหภูมิหลังการเปลี่ยนหน่วยแล้ว
```
...
```text
Step 1:รับค่าอุณหภูมิและหน่วยทั้งก่อนและหลัง
Step 2:ตั้งเงื่อนไขใหญ่ว่าinputที่เข้ามาตรงกับหน่วยไหนบ้าง
Step 3:ตั้งเงื่อนไขย่อยอีกทีว่าจะเปลี่ยนเป็นหน่วยไหนและคำนวน
Step 4:แสดงผล
```
...
```text
ตรงตามแผนแรกทุกอย่างรับค่าทุกอย่างเช็ตเงื่อนไขและคำนวนแล้วแสดงผล
```
...
```text
บอกใบ้ในtestcaseที่ยังไม่ผ่าน
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดด้วยตัวเองทั้งหมด
```
