...
```text
inputรับค่าตัวเลขเป็นจำนวนรอบ และ ค่า+,-ในการคำนวนคะแนนเงื่อนไขคือถ้า+ ให้เพิ่มคะแนน10คะแนนถ้า-ให้ลดคะแนน5คะแนน แสดงoutputเป็นค่าคะแนนทั้งหมด
```
...
```text
Step 1:รับค่าinputเป็นเลขจำนวนเต็ม
Step 2:ใช้for loop โดย rangeเท่ากับจำนวนเต็มที่รับมา
Step 3:ใช้ifตั้งเงื่อนไขตามโจทย์ คำนวนแสดงผล
```
...
```text
เหมือนวิธีแรกทุกอย่างเพราะมันสามารถใช้งานได้เลยไม่ได้มีการปรับเปลี่ยน
```
