...
```text
อินเป็นเลข1เลข แล้วoutputออกมาเป็นเลขตั้งแต่ค่าแรกถอยลงมาจนถึง0ที่หาร10ลงตัว เงื่อนไขสำคัญคือต้องเป็นเลขที่หาร10ลงตัว
```
...
```text
Step 1:รับค่าเลข
Step 2:ใช้ลูปตั้งเงื่อนไขในการหาเลขที่หารด้วย10ลงตัว
Step 3:เพิ่มเลขนั้นเข้าไปในลิสและแสดงผล
```
...
```text
เหมือนกับวิธีแรกทุกอย่างเพราะเป็นโจทย์ที่ไม่ได้ซับซ้อนมาก
```
