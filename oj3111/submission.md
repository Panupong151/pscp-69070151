...
```text
inputเป็นค่าstrว่าเป็นสมาชิกหรือไม่ถ้าเป็น"Y"ถ้าไม่"N" จำนวนรายการสินค้า และราคาสินค้า ouputเป็นราคาที่หักส่วนลดแล้ว เงื่อนไขคือถ้าเป็นสามาชิกลด5%ถ้าไม่ใช่แต่ยอดก่อนลดมากกว่าเท่ากับ500ลด3%ถ้าไม่ตรงเงื่อนไขก็ไม่ลด
```
...
```text
Step 1:รับค่าstrว่าเป็นสมาชิกหรือไม่ มีรายการสินค้ากี่รายการ แต่ละรายการ ราคาเท่าไหร่
Step 2:นำพิจาราณาตามเงื่อนไขที่โจทย์กำหนดแล้วลดราคาตามเงื่อนไข
Step 3:แสดงผล
```
...
```text
เหมือนแผนแรกเพราะเมื่อใช้แล้วสามารถใช้งานได้
```
...
```text
ทดสอบคนที่ไม่เป็นสมาชิกที่มียอดรวม 499.99 บาทจะต้องไม่ได้รับส่วนลด และแสดงผลยอดเต็มตามเดิม
```
