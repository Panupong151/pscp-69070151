...
```text
รับแม่สีสองสีแสดงผลออกมาเป็นสีที่ผสมกัน
```
...
```text
Step 1:รับค่าสีแม่สี2สี
Step 2:ใช้ifและelifตั้งเงื่อนไขการผสมสี
Step 3:แสดงผล
```
...
```text
รับค่าแม่สี2สีตั้งเงื่อนไขในifและelifและelse ว่าถ้าสีไหนผสมสีไหนได้สีไหน และ ตั้งเงื่อนไขในกรณีที่สี่เป็นสีเดียวกันด้วย และแสดงผล
```
...
```text
ใบ้testcaseที่ไม่ผ่านว่าเงื่อนไขคืออะไร
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนcodeทั้งหมด คิดตั้งเงื่อนไขใหม่เอง
```
